...
class feedback_uncompleted:
    def __init__(self):
        self.con = common_class()

    def question_feedback(self, direction='up', percent=0.9, duration=None):
