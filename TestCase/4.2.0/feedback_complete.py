...
class feedback_complete:
    ...
    def question_feedback(self, direction='up', percent=0.4, duration=None):
        ...
        try:
            ...
            content.send_keys(u'不好用，好用，还不错    好用 界面漂亮，资源多，下载快，资源多，下载快，占内存少    好')
            time.sleep(1)
